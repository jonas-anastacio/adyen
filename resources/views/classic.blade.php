...
<body>
    <div class="fixed-top list-group col-3">
        <li class="list-group-item font-weight-bold text-white bg-info">Card: 5101180000000007(Master) 4000620000000007(Visa)</li>
        <li class="list-group-item font-weight-bold text-white bg-info">expiryMonth: 10(Master) 03(Visa)</li>
        <li class="list-group-item font-weight-bold text-white bg-info">expiryYear: 2020(Master) 2030(Visa)</li>
        <li class="list-group-item font-weight-bold text-white bg-info">CVC: 737(both)</li>
    </div>
    ...
    <form action="{{ route('classic.credit') }}" method="post" class="d-flex align-items-center position-ref h-100" id="adyen-encrypted-form">
        ...
        <div class="mx-auto col-12 row m-0" style="max-width: 700px;">
            ...
            <div class="col-6">
                <div class="form-group">
                    <label for="">Cartão de créito</label>
                    <input type="text" size="20" data-encrypted-name="number" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">Vencimento (Mês)</label>
                    <input type="text" size="2" data-encrypted-name="expiryMonth" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">Vencimento (Ano)</label>
                    <input type="text" size="4" data-encrypted-name="expiryYear" class="form-control" />
                </div>
                <div class="form-group">
                    <label for="">CVC</label>
